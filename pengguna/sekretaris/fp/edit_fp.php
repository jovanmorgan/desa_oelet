...
$select_query = "SELECT fp FROM sekretaris WHERE id_sekretaris = '$id_sekretaris'";
...
// Update nama gambar di tabel sekretaris berdasarkan id_sekretaris
$update_query = "UPDATE sekretaris SET fp = '$filename' WHERE id_sekretaris = '$id_sekretaris'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel sekretaris
