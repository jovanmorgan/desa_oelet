                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="editDataFp">
                                                <div class="row">
                                                    <input type="hidden" class="form-control" name="id_kepala_desa"
                                                        id="id_kepala_desa" value="<?php echo $kepala_desa['id_kepala_desa']; ?>">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Nama</label>
                                                            <input type="text" class="form-control" placeholder="nama" name="nama"
                                                                id="nama" value="<?php echo $kepala_desa['nama']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Username"
                                                                ...
                                                                value="<?php echo $kepala_desa['username']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Password"
                                                                ...
                                                                value="<?php echo $kepala_desa['password']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
