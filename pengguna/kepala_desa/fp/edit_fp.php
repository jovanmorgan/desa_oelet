...
$select_query = "SELECT fp FROM kepala_desa WHERE id_kepala_desa = '$id_kepala_desa'";
...
// Update nama gambar di tabel kepala_desa berdasarkan id_kepala_desa
$update_query = "UPDATE kepala_desa SET fp = '$filename' WHERE id_kepala_desa = '$id_kepala_desa'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel kepala_desa
