        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="anggaran_dana/tambah.php" method="POST"
                                enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="jumlah_anggaran">Jumlah Anggaran :</label>
                                    <input type="text" min="0" class="form-control" id="jumlah_anggaran"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" min="0" class="form-control" id="saldo_kas" name="saldo_kas"
                                        required>
                                </div>
                                <div class="form-group">
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        const sumber_anggaran = document.getElementById('sumber_anggaran');
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="anggaran_dana/edit.php" method="POST"
                                enctype="multipart/form-data">
                                <input type="hidden" id="editid_anggaran_dana" name="id_anggaran_dana">
                                <div class="form-group">
                                    <label for="jumlah_anggaran">Jumlah Anggaran :</label>
                                    <input type="text" min="0" class="form-control" id="editjumlah_anggaran"
                                        name="jumlah_anggaran" required>
                                </div>
                                <div class="form-group">
                                    <label for="sumber_anggaran">Sumber Anggaran :</label>
                                    <input type="text" class="form-control" id="editsumber_anggaran"
                                        name="sumber_anggaran" required>
                                </div>
                                <div class="form-group">
                                    <label for="saldo_kas">Saldo Kas :</label>
                                    <input type="text" min="0" class="form-control" id="editsaldo_kas" name="saldo_kas"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="id_bidang">bidang:</label>
            ...
            <script>
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    const editsumber_anggaran = document.getElementById('editsumber_anggaran');
                                        ...
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="anggaran_dana/cetak" target="_blank"
