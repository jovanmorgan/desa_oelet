    ...
    <div class="wrapper">
            ...
            <div class="sidebar-wrapper bg-white ">
                <div class="logo">
                    ...
                    <a href="javascript:void(0)" class="simple-text logo-normal position-relative"
                        style="font-size: 14px; font-weight: bold; font-style: italic; right: 5px; color: #000000;"
                        translate="no">
                        Desa Oelet
                    </a>
                ...
                <ul class="nav">
                    ...
                    <li>
                        <a href="./admin_data_kepala_desa">
                            <i class="tim-icons icon-single-02" style="font-size: 24px; color: #000000;"></i>
                            <!-- Ikon orang -->
                    ...
                    <li>
                        <a href="./admin_data_sekretaris">
                            <i class="tim-icons icon-badge" style="font-size: 24px; color: #000000;"></i>
                            <!-- Ikon lencana -->
                    ...
                    <li>
                        <a href="./admin_data_anggaran_dana">
                            <i class="tim-icons icon-coins" style="font-size: 24px; color: #000000;"></i>
                            <!-- Ikon koin -->
                    ...
                    <li>
                        <a href="./admin_data_program_kerja">
                            <i class="tim-icons icon-notes" style="font-size: 24px; color: #000000;"></i>
                            <!-- Ikon catatan -->
                    ...
                    <li>
                        <a href="./admin_data_kegiatan">
                            <i class="tim-icons icon-calendar-60" style="font-size: 24px; color: #000000;"></i>
                            <!-- Ikon kalender -->
                    ...
                    <li>
                        <a href="./admin_data_realisasi">
                            <i class="tim-icons icon-check-2" style="font-size: 24px; color: #000000;"></i>
                            <!-- Ikon ceklis -->
                    ...
                    <li>
                        <a href="./admin_data_bidang">
                            <i class="tim-icons icon-align-center" style="font-size: 24px; color: #000000;"></i>
                            <!-- Ikon penyelarasan -->
                    ...
                    <li>
                        <a href="./admin_data_rab">
                            <i class="tim-icons icon-paper" style="font-size: 24px; color: #000000;"></i>
                            <!-- Ikon dokumen -->
        ...
        <div class="main-panel">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="dropdown nav-item">
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li class="nav-link"><a href="foto_profile" class="nav-item dropdown-item"
                                            style="font-size: 14px; font-weight: bold; color: black">Profile</a></li>
                                    <li class="nav-link"><a href="logout" class="nav-item dropdown-item"
                                            style="font-size: 14px; font-weight: bold; color: black">Log
                                            out</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="program_kerja/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    <label for="id_anggaran_dana">Dana Anggaran :</label>
                                ...
                                <div class="form-group">
                                    <label for="jumlah_anggaran_program">Jumlah Angaran Program Kerja:</label>
                                    <input type="text" class="form-control" id="jumlah_anggaran_program"
                                        name="jumlah_anggaran_program" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="periode_pelaksanaan"
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                const jag = document.getElementById('jumlah_anggaran_program');
                const ejag = document.getElementById('edit_jumlah_anggaran_program');
                ...
                const validateForm = () => {
                    jag.value = parseNumber(jag.value);
                    ejag.value = parseNumber(ejag.value);
                };
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="update_program_kerja.php" method="POST"
                                ...
                                <div class="form-group">
                                    <label for="editid_anggaran_dana">Dana Anggaran :</label>
                                ...
                                <div class="form-group">
                                    <label for="jumlah_anggaran_program">Jumlah Angaran Program Kerja:</label>
                                    <input type="text" class="form-control" id="edit_jumlah_anggaran_program"
                                        name="jumlah_anggaran_program" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="editperiode_pelaksanaan"
                                        name="periode_pelaksanaan" required>
                                </div>
                                <div class="form-group">
            ...
            <script>
            function openEditModal(id_program_kerja, nama_program, id_anggaran_dana, jumlah_anggaran_program,
                tujuan_program,
                ...
                document.getElementById('edit_jumlah_anggaran_program').value = jumlah_anggaran_program;
                                        ...
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="program_kerja/cetak" target="_blank"
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        <thead class=" text-primary">
                                            <tr>
                                                ...
                                                <th class="text-center column-fixed">Dana Anggaran</th>
                                                <th class="text-center column-fixed">Jumlah Anggaran Program Kerja</th>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $periode_pelaksanaan_input_data = ($periode_pelaksanaan_input);
                                                    echo "<tr>";
                                                    ...
                                                    echo "<td class='text-center'>" . htmlspecialchars($row['jumlah_anggaran_program'], ENT_QUOTES) . "</td>";
                                                    ...
                                                    echo "<td class='text-center'>
                                                                <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                                    ...
                                                                    \"" . htmlspecialchars($row['jumlah_anggaran_program'], ENT_QUOTES) . "\",
            ...
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    ...
                    if (response === 'success') {
                        ...
                        swal("Saldo kas Tidak cukup",
                            "Saldo kas Tidak Mencukupi, Silakan kurangi jumlah anggaran Program Kerja",
                            "info");
                    ...
                    xhr.onload = function() {
                        ...
                        if (xhr.status === 200) {
                            ...
                            if (response === 'success') {
                                ...
                                loadTable();
                            } else if (response === 'data_tidak_ada') {
                                swal("Error", "Data Tidak Ada",
                                    "info");
                            } else if (response === 'saldo_kas_tidak_ditemukan') {
                                swal("Error", "Saldo Kas Tidak Data Tidak Ada",
                                    "info");
                            } else if (response === 'gagal_mengupdate_saldo_kas') {
                                swal("Error", " Gagal Mengupdate Saldo Kas",
                                    "info");
                            } else {
